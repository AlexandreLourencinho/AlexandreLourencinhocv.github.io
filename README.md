# Il s'agit ici de mon CV en ligne. il existe en deux versions, une plus "classique" et une version "synthwave". Cette dernière à surtout été pour moi un genre de "défi", pour 
